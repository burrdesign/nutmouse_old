...
<div class="mask_intro">
	<h2 class="mask_title"><span class="icon icon-filter-2"></span> Seitenaufrufe</h2>
	<p class="mask_desc">Hier sehen Sie eine &Uuml;bersicht &uuml;ber die Seitenzugriffe im angegeben Zeitraum. Dabei werden Zugriffe durch Robots automatisch gefiltert. Weitere Filter k&ouml;nnen Sie in den Einstellungen vornehmen.</p>
</div>
...
<div class="wrap_diagramm wrap_diagramm_pagecnt wrap_diagramm_box_full" style="margin-top:20px;">
	<!-- Seitenzugriffe -->
	<?php include($_SERVER['DOCUMENT_ROOT'] . "/core/templates/_nutmouse/admin/modules/stats/widgets/pagecnt.tpl"); ?>
</div>